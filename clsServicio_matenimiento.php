...
class Servicio_Mantenimiento extends Conexion
{
	...
	public function Servicio_Mantenimiento2($codigo,$fecha,$firma_invetsa,$firma_jefe_planta,$hora_ingreso,$hora_salidas,$id_compania,$id_maquina,$id_tecnico,$revision,$id_sqlite,$imei,$formulario,$foto_jefe,$jefe_planta,$encargado_maquina,$ultima_visita,$planta_de_incubacion,$direccion  )
	{
