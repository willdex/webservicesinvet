  ...
  try
  {
    foreach($array as $obj)
    {
      //inicio se registro de SERVICIO MANTENIMIENTO.
                       ...
                       $servicio_m->Servicio_Mantenimiento2($codigo,$fecha,$firma_invetsa,$firma_jefe_planta,$hora_ingreso,$hora_salidas,$id_compania,$id_maquina,$id_tecnico,$revision,$id,$imei,$formulario,$imagen_jefe,$jefe_planta,$encargado_maquina,$ultima_visita,$planta_de_incubacion,$direccion,$encargado_maquina);
